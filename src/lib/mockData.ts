...
export const MOCK_REVIEWS: Review[] = [
  {
    id: "rev-1",
    reviewRef: "REV-2026-9011",
    bookingId: "bk-9001",
    bookingNumber: "CC-2026-8812",
    authorId: "usr-201",
    authorName: "Michael Jordan",
    authorAvatar: "https://images.unsplash.com/photo-1535713875002-d1d0cf377fde?w=100&auto=format&fit=crop&q=80",
    authorEmail: "michael.j@example.com",
    companionId: "comp-101",
    companionName: "Sophia Chen",
    companionAvatar: "https://images.unsplash.com/photo-1534528741775-53994a69daeb?w=500&auto=format&fit=crop&q=80",
    rating: 5,
    subRatings: { punctuality: 5, behavior: 5, communication: 5, authenticity: 5 },
    category: "Event Companion",
    ...
    sentiment: "POSITIVE",
    status: "APPROVED",
    adminNotes: "Auto-approved. High positive sentiment."
  },
  {
    id: "rev-2",
    reviewRef: "REV-2026-9012",
    bookingId: "bk-9002",
    bookingNumber: "CC-2026-9043",
    authorId: "usr-202",
    authorName: "Margaret Jenkins",
    authorAvatar: "https://images.unsplash.com/photo-1494790108377-be9c29b29330?w=100&auto=format&fit=crop&q=80",
    authorEmail: "margaret.j@example.com",
    companionId: "comp-102",
    companionName: "Alexander Wright",
    companionAvatar: "https://images.unsplash.com/photo-1507003211169-0a1dd7228f2d?w=500&auto=format&fit=crop&q=80",
    rating: 5,
  ...
  },
  {
    ...
    authorEmail: "thomas.w@example.com",
    ...
    rating: 5,
    subRatings: { punctuality: 5, behavior: 5, communication: 4, authenticity: 5 },
  ...
  {
    id: "rev-4",
    reviewRef: "REV-2026-9014",
    bookingId: "bk-9004",
    bookingNumber: "CC-2026-6620",
    authorId: "usr-204",
    authorName: "Anonymous User",
    authorAvatar: "https://images.unsplash.com/photo-1534528741775-53994a69daeb?w=100&auto=format&fit=crop&q=80",
    authorEmail: "anon901@example.com",
    ...
    rating: 1,
    subRatings: { punctuality: 1, behavior: 1, communication: 1, authenticity: 1 },
    category: "Gaming Companion",
    comment: "Spam text detected! Call me at +1-800-FAKE-NUM or visit suspicious-link.com for free tokens!",
    helpfulVotes: 0,
    ...
    status: "FLAGGED",
    flaggedReason: "Automated filter triggered: External promotional URLs and phone numbers.",
    flaggedBy: "AUTOMATED_PROFANITY_FILTER"
  },
  {
    id: "rev-5",
    reviewRef: "REV-2026-9015",
    bookingId: "bk-9005",
    bookingNumber: "CC-2026-5541",
    authorId: "usr-205",
    authorName: "Robert Vance",
    authorAvatar: "https://images.unsplash.com/photo-1500648767791-00dcc994a43e?w=100&auto=format&fit=crop&q=80",
    authorEmail: "robert.vance@example.com",
    ...
    rating: 4,
    subRatings: { punctuality: 4, behavior: 5, communication: 4, authenticity: 4 },
    category: "Fitness & Outdoor",
    comment: "Good session, arrived 5 minutes late due to traffic, but overall workout guidance was excellent.",
    helpfulVotes: 3,
