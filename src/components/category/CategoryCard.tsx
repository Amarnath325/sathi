...
import {
  ...
  Star, ArrowRight, Eye, Edit2, Trash2, Maximize2
} from 'lucide-react';
...
export function CategoryCard({
  ...
  const bannerImgUrl = category.bannerUrl || 'https://images.unsplash.com/photo-1511578314322-379afb476865?w=800&auto=format&fit=crop&q=80';
  ...
  return (
    <>
      <div className={`rounded-xl border transition-all duration-300 flex flex-col overflow-hidden group hover:shadow-md ${
        ...
        {/* Banner / Cover Header - Click to open full-size image preview */}
        <div
          className="relative h-48 sm:h-52 overflow-hidden bg-slate-100 dark:bg-slate-950 cursor-pointer"
          onClick={() => setLightboxImage(bannerImgUrl)}
